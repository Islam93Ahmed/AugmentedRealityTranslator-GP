...
public class ConnectComponent
{
     ...
     */
    public int[] compactLabeling(int[] image,int height, int width, boolean zeroAsBg)
    {
        //label first
        int[] label= labeling(image,height, width,zeroAsBg);
     ...
     */
    public int[] labeling(int[] image, int h, int w, boolean zeroAsBg)
    {
